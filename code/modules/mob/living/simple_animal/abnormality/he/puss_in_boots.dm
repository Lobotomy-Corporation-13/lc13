...
/mob/living/simple_animal/hostile/abnormality/puss_in_boots/proc/Finisher(mob/living/target) //This is super easy to avoid
	target.deal_damage(50, PALE_DAMAGE, src, overrides = list(blocked = target.run_armor_check(null, RED_DAMAGE), spread_damage = TRUE)) //50% of your health in red damage
