...
/mob/living/simple_animal/hostile/abnormality/forsaken_murderer/Worktick(mob/living/carbon/human/user, bubble_type = ABNO_BUBBLE_GENERIC | ABNO_BUBBLE_SPECIFIC, work_type)
