...
/mob/living/carbon/attacked_by(obj/item/I, mob/living/user)
	...
	if(I.force)
		...
		deal_damage(damage, I.damtype, flags = (DAMAGE_WHITE_HEALABLE), attack_type = (ATTACK_TYPE_MELEE), def_zone = affecting, wound_bonus = I.wound_bonus, bare_wound_bonus = I.bare_wound_bonus, sharpness = I.get_sharpness())
