...
/mob/living/bullet_act(obj/projectile/P, def_zone, piercing_hit = FALSE)
	...
	if(!P.nodamage && on_hit_state != BULLET_ACT_BLOCK)
		deal_damage(P.damage, P.damage_type, source = P.firer, flags = (P.white_healing ? DAMAGE_WHITE_HEALABLE : NONE) | (P.no_sinking ? DAMAGE_NO_SINKING : NONE), attack_type = (ATTACK_TYPE_RANGED), def_zone = def_zone, wound_bonus=P.wound_bonus, bare_wound_bonus=P.bare_wound_bonus, sharpness = P.sharpness)
