...
/obj/item/clothing/suit/armor/ego_gear/city/kcorp_l1_old
	name = "K corp L1 armor"
	desc = "Armor worn by Kcorp security."
	icon_state = "kcorp_l1_old"
...
/obj/item/clothing/suit/armor/ego_gear/city/kcorp_l3_old
	name = "K corp L3 armor"
	desc = "Armor worn by Kcorp excision staff."
	icon_state = "kcorp_l3_old"
	armor = list(RED_DAMAGE = 50, WHITE_DAMAGE = 40, BLACK_DAMAGE = 40, PALE_DAMAGE = 20)
	hat = /obj/item/clothing/head/ego_hat/helmet/kcorp_l3_old
	attribute_requirements = list(
...
/obj/item/clothing/suit/armor/ego_gear/city/kcorp_sci_old
...
/obj/item/clothing/head/ego_hat/helmet/kcorp_l3_old
	name = "\improper k-corp l3 helmet"
	desc = "A helmet worn by k-corp."
	icon_state = "kcorp_l3"

//Below clothing is sprited by PositiveEntropy. Quite drippy!
...
/obj/item/clothing/head/ego_hat/helmet/kcorp
	name = "k-corp L1 helmet"
	desc = "A riot helmet worn by k-corp."
	icon_state = "kcorp_l1_helm"
	perma = TRUE

/obj/item/clothing/head/ego_hat/helmet/kcorp_l3
	name = "\improper k-corp l3 helmet"
	desc = "A helmet worn by k-corp."
	icon_state = "kcorp_l3_helm"
