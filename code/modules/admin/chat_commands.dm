...
/datum/tgs_chat_command/tgscheck/Run(datum/tgs_chat_user/sender, params)
	...
	var/map_name = current_map_config.has_submaps ? "[current_map_config.map_name]" + ": " + "[current_map_config.available_submaps[current_map_config.map_file]]" : current_map_config.map_name
	var/check = "[GLOB.round_id ? "Round #[GLOB.round_id]: " : ""][GLOB.clients.len] players on [map_name]; Alert level: [capitalize(get_security_level())].\n"
	var/round_time = world.time - SSticker.round_start_time
