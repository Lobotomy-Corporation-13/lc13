...
/datum/preferences/proc/load_preferences()
	...
	READ_FILE(S["player_ambience_volume"], player_ambience_volume)
	...
	player_ambience_volume = sanitize_integer(player_ambience_volume, 0, 100, initial(player_ambience_volume))
...
/datum/preferences/proc/save_preferences()
	...
	WRITE_FILE(S["player_ambience_volume"], player_ambience_volume)
