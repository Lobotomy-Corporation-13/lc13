...
/obj/machinery/sleeper
	...
	var/list/possible_chems = list(
		list(/datum/reagent/medicine/epinephrine, /datum/reagent/abnormality/healing_gel, /datum/reagent/abnormality/sanity_gel, /datum/reagent/burn_salve, /datum/reagent/antitoxin, /datum/reagent/purgall),
		list(),
		list(),
		list()
	)
