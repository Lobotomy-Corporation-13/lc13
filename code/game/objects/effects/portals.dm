...
/obj/effect/portal/proc/teleport(atom/movable/M, force = FALSE)
	...
	if(do_teleport(M, real_target, innate_accuracy_penalty, no_effects = no_effect, channel = teleport_channel, forced = force_teleport, null, null, sparks, TELEPORT_CHANNEL_BLUESPACE, FALSE))
