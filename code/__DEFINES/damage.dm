...
/// Set this bitflag to mark the attack as coming from the environment (freezing, drowning in the Great Lakes, etc...)
...
/// This is for when the damage is coming from somewhere that doesn't easily fit one of the other categories..
