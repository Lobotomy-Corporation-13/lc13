...
/datum/chemical_reaction/zephyrium_chloride
	...
	required_reagents = list(/datum/reagent/nexalite = 1, /datum/reagent/omnicarbide = 1, /datum/reagent/plasmorite = 1)

/datum/chemical_reaction/hyperlithium_oxide
	results = list(/datum/reagent/hyperlithium_oxide = 1)
	required_reagents = list(/datum/reagent/cryovium = 1, /datum/reagent/synthryl = 1, /datum/reagent/quantaferrite = 1)
