...
/obj/item/office_marker/syndicate
	...
	icon_state = "delivery"
	inhand_icon_state = "flashbang"
	usable_roles = list("Blade Lineage Cutthroat", "Index Messenger", "Kurokumo Kashira", "Grand Inquisitor", "Thumb Sottocapo", "Thumb East Capo", "New League of Nine Project Supervisor")
